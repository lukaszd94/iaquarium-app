 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ut(e){Ke(new S("platform-logger",(e=>new oe(e)),"PRIVATE")),Ke(new S("heartbeat",(e=>new at(e)),"PRIVATE")),Ge(le,ue,e),Ge(le,ue,"esm2017"),Ge("fire-js","")}ut("");var ht="firebase",dt="9.14.0";
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kt=new Map;function Ht(e,t){const n=qt(e);$t(n,t),Ft(n,t)}function $t(e,t){const n=Kt.get(e);if(n)for(const i of n)i(t)}function Ft(e,t){const n=Vt();n&&n.postMessage({key:e,fid:t}),zt()}let Wt=null;function Vt(){return!Wt&&"BroadcastChannel"in self&&(Wt=new BroadcastChannel("[Firebase] FID Change"),Wt.onmessage=e=>{$t(e.data.key,e.data.fid)}),Wt}function zt(){0===Kt.size&&Wt&&(Wt.close(),Wt=null)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gt="firebase-installations-database",Jt=1,Yt="firebase-installations-store";let Qt=null;function Xt(){return Qt||(Qt=te(Gt,Jt,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(Yt)}}})),Qt}async function Zt(e,t){const n=qt(e),i=await Xt(),r=i.transaction(Yt,"readwrite"),a=r.objectStore(Yt),s=await a.get(n);return await a.put(t,n),await r.done,s&&s.fid===t.fid||Ht(e,t.fid),t}async function en(e){const t=qt(e),n=await Xt(),i=n.transaction(Yt,"readwrite");await i.objectStore(Yt).delete(t),await i.done}async function tn(e,t){const n=qt(e),i=await Xt(),r=i.transaction(Yt,"readwrite"),a=r.objectStore(Yt),s=await a.get(n),o=t(s);return void 0===o?await a.delete(n):await a.put(o,n),await r.done,!o||s&&s.fid===o.fid||Ht(e,o.fid),o}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tn="installations",Dn="installations-internal",On=e=>{const t=e.getProvider("app").getImmediate(),n=En(t),i=He(t,"heartbeat"),r={app:t,appConfig:n,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()};return r},An=e=>{const t=e.getProvider("app").getImmediate(),n=He(t,Tn).getImmediate(),i={getId:()=>Cn(n),getToken:e=>In(n,e)};return i};function Rn(){Ke(new S(Tn,On,"PUBLIC")),Ke(new S(Dn,An,"PRIVATE"))}Rn(),Ge(ft,pt),Ge(ft,pt,"esm2017");
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function qn(e){const t=new Uint8Array(e),n=btoa(String.fromCharCode(...t));return n.replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function Kn(e){const t="=".repeat((4-e.length%4)%4),n=(e+t).replace(/\-/g,"+").replace(/_/g,"/"),i=atob(n),r=new Uint8Array(i.length);for(let a=0;a<i.length;++a)r[a]=i.charCodeAt(a);return r}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ki("hts/frbslgigp.ogepscmv/ieo/eaylg","tp:/ieaeogn-agolai.o/1frlglgc/o"),ki("AzSCbw63g1R0nCw85jG8","Iaya3yLKwmgvh7cF0q4");class qi{constructor(e,t,n){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const i=Ui(e);this.firebaseDependencies={app:e,appConfig:i,installations:t,analyticsProvider:n}}_delete(){return Promise.resolve()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ki=e=>{const t=new qi(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return self.addEventListener("push",(e=>{e.waitUntil(Di(e,t))})),self.addEventListener("pushsubscriptionchange",(e=>{e.waitUntil(Ti(e,t))})),self.addEventListener("notificationclick",(e=>{e.waitUntil(Oi(e))})),t};function Hi(){Ke(new S("messaging-sw",Ki,"PUBLIC"))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
